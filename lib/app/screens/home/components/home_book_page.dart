                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image:
                                            NetworkImage(state.selectedImage))),
                              ),
                              SizedBox(
                                height: 5,
                              ),
                              Row(
                                children: data['images'].map<Widget>((e) {
                                  int index = data['images'].indexOf(e);
                                  return InkWell(
                                    onTap: () {
                                      BlocProvider.of<HomeBloc>(context)
                                        ..add(
                                            HomeChangeSelectedImage(image: e));
                                    },
                                    child: Container(
                              ...
                              Row(
                                ...
                                children: [
                                  BookInfoCard(
                                      ...
                                      data: data['routes'].length.toString(),
                          ...
                          GestureDetector(
                            ...
                            child: BookChooseFlareCard(
                                ...
                                datas: [
                                  ...
                                  {
                                    'isCheck': true,
                                    'text': 'Full cancellation up to 24 hours ',
                                  },
                                  {
                                    'isCheck': true,
                                    'text': 'Baggage 30 kg',
