...
class AppColors {
  static final LinearGradient kPrimaryGradientGreenColor = const LinearGradient(
    colors: [Color.fromRGBO(0, 157, 174, 1), Color.fromRGBO(0, 157, 174, 1)],
    stops: [0.25, 0.75],
  ...
  static final Color kPrimaryGreen = Color.fromRGBO(0, 157, 174, 1);
  ...
  static const Color primary = Color.fromRGBO(0, 157, 174, 1);
